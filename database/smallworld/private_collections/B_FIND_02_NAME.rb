_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\00_MODULOS\\Z_CALIDAD\\Z_DELETE\\FIBRA CORRUCTA - C.71212.shp\\INFR_01_BUILDING\\FIND\\Z_B_F_02_NAME.txt"
    ruta_salida << "C:\\A_GS1_PROYECTOS\\00_MODULOS\\Z_CALIDAD\\Z_DELETE\\FIBRA CORRUCTA - C.71212.shp\\INFR_01_BUILDING\\FIND\\Z_B_F_OUTPUT.txt"
    ...
    vista.checkpoint("FindBuildingByName")
    ...
    _loop
        ...
        posibles << buildings.select(predicate.eq(:name, nombre_a_buscar))
