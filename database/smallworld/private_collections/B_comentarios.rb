_block
    ruta_fuente <<"C:\\Users\\jeinvel1\\Desktop\\comments_report.txt"
    # "C:\A_GS1_PROYECTOS\0_Documents_gs\src\private_collections\InfraBuilding\EDIT\Z_B_comments.txt"

    vista << gis_program_manager.cached_dataset(:gis)
    vista.checkpoint("building_cms")
    ...
    _loop
        ...
        comentarios_value << texto[2].write_string
        ...
        _then
            _try
                un_building.comentarios << comentarios_value
