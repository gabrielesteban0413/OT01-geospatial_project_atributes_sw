_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\ConnSheathSplice\\TXT\\E_Spec.txt"

    vista << gis_program_manager.cached_dataset(:gis)
    vista.checkpoint("EM SPEC")
    ...
    _loop   
        ...
        _then
            _try
                un_sheath_splice.spec_id << nuevo_valor
