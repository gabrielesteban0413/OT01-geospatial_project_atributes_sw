_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\ConnSheathWithLoc\\find\\TX_SWL_Find_name_old.txt"
    ...
    vista.checkpoint("FindSheathWithLocFantiguo")
    ...
    _loop
        ...
        posibles << sheath_with_locs.select(predicate.eq(:nombre_antiguo, nombre_a_buscar))
