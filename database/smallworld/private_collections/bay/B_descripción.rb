_block
    ruta_fuente << "C:\A_GS1_PROYECTOS\0_Documents_gs\src\private_collections\ConnBay\B01_description.txt"
    ...
    _loop
        ...
        _then
            _try
                un_bay.description << description_value
