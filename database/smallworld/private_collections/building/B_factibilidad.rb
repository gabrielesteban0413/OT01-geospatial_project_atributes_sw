_block
    ruta_fuente << "C:\Users\jeinvel1\Desktop\Z_B_factibilidad.txt"
    #"C:\A_GS1_PROYECTOS\0_Documents_gs\src\private_collections\InfraBuilding\EDIT\Z_B_factibilidad.txt"

    vista << gis_program_manager.cached_dataset(:gis)
    vista.checkpoint("building_fac")
    ...
    _loop
        ...
        factibilidad_value << texto[2].write_string
        ...
        _then
            _try
                un_building.no_factibilidad << factibilidad_value
