_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\ConnShelf\\S01_direccion_ip.txt"
    ...
    _loop
        ...
        _then
            _try
                un_mit_shelf.direccion_ip << nuevo_valor   
    ...
    show("--------------GS--EDIT-SHELF-direccion_ip----------.")
