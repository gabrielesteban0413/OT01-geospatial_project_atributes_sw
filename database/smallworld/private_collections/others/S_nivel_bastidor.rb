_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\ConnShelf\\S01_nivel_bastidor.txt"

    vista << gis_program_manager.cached_dataset(:gis)
    vista.checkpoint("mit_shelf")
    ...
    _loop
        ...
        _then
            _try
                un_mit_shelf.nivel_en_bastidor << nuevo_valor   
    ...
    show("--------------GS--EDIT-SHELF-NIVEL-EN-EL-BASTIDOR----------.")
