_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\ConnPort\\P01_ancho_de_banda6.txt"
    ...
    _loop
        ...
        _then
            _try
                un_mit_rme_port.ancho_de_banda << nuevo_valor  
