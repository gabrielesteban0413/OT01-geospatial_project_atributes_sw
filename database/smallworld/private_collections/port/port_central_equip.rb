_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\scripts\\monitoring\\private_collections\\00_out2.txt"
    vista << gis_program_manager.cached_dataset(:gis)
    vista.checkpoint("PT_EQC_MS")  
    ...
    _loop
        ...
        equipo_central << texto[2].write_string
        ...
        _then
            _try
                un_port.equipo_central << equipo_central 
