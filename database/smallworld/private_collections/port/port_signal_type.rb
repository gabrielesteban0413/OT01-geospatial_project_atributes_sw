_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\ConnPort\\P01_type_señal.txt"
    #"C:\\Users\\jeinvel2\\Desktop\\P01_type_señal.txt"
    #"C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\ConnPort\\P01_type_señal.txt"
    #"C:\\Users\\jeinvel1\\Desktop\\F01_spec.txt"
    # "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\ConnSheathWithLoc\\edit\\F01_Spec.txt"

    vista << gis_program_manager.cached_dataset(:gis)
    vista.checkpoint("PT_BC")
    ...
    _loop
        ...
        _then
            _try
                un_mit_rme_port.tipo_senial << nuevo_valor
