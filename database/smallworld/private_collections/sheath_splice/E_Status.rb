_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\00_MODULOS\\Z_CALIDAD\\Z_AUTOMATIZACION\\CNT_04_SHEATH_SPLICE\\TXT\\E_Status.txt"

    vista << gis_program_manager.cached_dataset(:gis)
    vista.checkpoint("sheath_splice_status_abandono")  #IMPORT------------------
    sheath_with_locs << vista.collection(:sheath_splice)
    ...
    _loop
        ...
        _then
            _try
                un_sheath_with_loc.construction_status << nuevo_valor
  ...
  show("T_ exitosos: ", contador_exitosos)
    show("T_ fallidos: ", contador_fallidos)
