_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\ConnSheathSplice\\TXT\\E_name.txt"
    #"C:\\Users\\jeinvel1\\Desktop\\E_name.txt"

    vista << gis_program_manager.cached_dataset(:gis)
    vista.checkpoint("sheath_splice")
    ...
    _loop
        ...
        _then
            _try
                un_sheath_splice.name << name_value
