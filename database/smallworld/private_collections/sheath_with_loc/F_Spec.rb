_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\ConnSheathWithLoc\\edit\\F01_Spec.txt"
    ...
    _loop
        ...
        _then
            _try
                un_sheath_with_loc.spec_id << nuevo_valor
