_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\ConnSheathWithLoc\\edit\\F01_nodo.txt"

    vista << gis_program_manager.cached_dataset(:gis)
    vista.checkpoint("FI_NODO_MULT_A")
    ...
    _loop
        ...
        mit_hub_id1_value << texto[2].as_number()
        ...
        _then
            _try
                un_sheath_with_loc.mit_hub_id1 << mit_hub_id1_value
                valor_nuevo << un_sheath_with_loc.mit_hub_id1
                _if valor_nuevo = mit_hub_id1_value
                _then
