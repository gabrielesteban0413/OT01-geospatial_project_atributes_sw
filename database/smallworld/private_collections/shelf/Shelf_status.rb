_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\ConnShelf\\S01_status.txt"
    ...
    _loop
        ...
        _then
            _try
                un_mit_shelf.construction_status << nuevo_valor   
