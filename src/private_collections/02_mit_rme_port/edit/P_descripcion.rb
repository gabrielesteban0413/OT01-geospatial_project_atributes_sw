_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\02_mit_rme_port\\edit\\P01_description.txt"
    ...
    _loop
        ...
        description << texto[2].write_string
        ...
        _then
            _try
                un_port.description << description 
