_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\02_mit_rme_port\\edit\\P01_fecha_aprovisionamiento.txt"
    ...
    _loop
        ...
        fecha_str << texto[2].default("")
        _try
            fecha_aprovisionamiento << ds_date.new_from_string(fecha_str)
        _when error
            lista_modificada.add(linea + "|FALLIDO - fecha no parseable")
            contador_fallidos << contador_fallidos + 1
            _continue
        _endtry
        ...
        _then
            _try
                un_port.fecha_aprovisionamiento << fecha_aprovisionamiento
