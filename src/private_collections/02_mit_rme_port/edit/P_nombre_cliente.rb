_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\02_mit_rme_port\\edit\\P01_nombre_cliente.txt"
    ...
    _loop
        ...
        nombre_cliente << texto[2].write_string
        ...
        _then
            _try
                un_port.nombre_cliente << nombre_cliente 
