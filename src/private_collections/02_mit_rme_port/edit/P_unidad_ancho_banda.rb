_block
    ruta_fuente << "C:\\Users\\jeinvel2\\Desktop\\P01_unidad_ancho_banda.txt"
    #"C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\ConnPort\\P01_unidad_ancho_banda.txt"
    ...
    _loop
        ...
        _then
            _try
                un_mit_rme_port.unidad_ancho_banda << nuevo_valor
