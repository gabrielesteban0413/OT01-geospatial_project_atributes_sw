_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\ConnPort\\P01_direccion_cliente_id.txt"
    ...
    _loop
        ...
        # No necesitamos leer el valor del archivo, siempre será 8
        nuevo_valor << 8
