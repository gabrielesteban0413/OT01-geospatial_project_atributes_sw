_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\02_mit_rme_port\\edit\\P01_tipo_servicio.txt"
    ...
    _loop
        ...
        _then
            _try
                un_mit_rme_port.tipo_servicio << nuevo_valor
