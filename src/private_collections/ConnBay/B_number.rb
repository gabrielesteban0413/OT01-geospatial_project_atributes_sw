_block
    ruta_fuente << "C:\A_GS1_PROYECTOS\0_Documents_gs\src\private_collections\ConnBay\B01_number.txt"

    vista << gis_program_manager.cached_dataset(:gis)
    vista.checkpoint("bay_number")
    ...
    _loop
        ...
        number_value << texto[2].write_string
