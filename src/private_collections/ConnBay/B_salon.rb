_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\ConnBay\\B01_salon1.txt"
    vista << gis_program_manager.cached_dataset(:gis)
    vista.checkpoint("mit_bay_sl")  
    ports << vista.collection(:mit_bay)  
