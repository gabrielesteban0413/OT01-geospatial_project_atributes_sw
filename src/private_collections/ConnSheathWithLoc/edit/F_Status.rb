_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\ConnSheathWithLoc\\edit\\F01_Status.txt"

    vista << gis_program_manager.cached_dataset(:gis)
    vista.checkpoint("STATUS")
