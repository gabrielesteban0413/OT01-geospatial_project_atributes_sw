_block
    ...
    _loop
        ...
        _then
            description_old << un_objeto.nombre_antiguo.write_string
            description_text << un_objeto.description.write_string
            results.add( '"' + id + '"|' + description_text ) # + "|" + description_text
        _else
            results.add(id + "&!")
        _endif
    _endloop
