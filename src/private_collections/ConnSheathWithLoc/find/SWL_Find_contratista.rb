_block
    input_file_path << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\Private_Collections\\ConnSheathWithLoc\\find\\TX_SWL_Find_comments2.txt"
    output_file_path << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\Private_Collections\\ConnSheathWithLoc\\find\\TX00_SWL_Find_output1.txt"
    ...
    _loop
        ...
        _then
            contratista_old << un_objeto.nombre_antiguo.write_string
            contratista_text << un_objeto.contratista.write_string
            results.add( '"' + id + '"|' + contratista_text ) # + "|" + contratista_text
        _else
            results.add(id + "&!")
        _endif
    _endloop
