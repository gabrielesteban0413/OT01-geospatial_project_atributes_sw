_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\0_Documents_gs\\src\\private_collections\\InfraBuilding\\EDIT\\B01_direccion_cliente_id.txt"
    ...
    _loop
        ...
        direccion_cliente_id_value << texto[2].write_string
        ...
        _then
            _try
                un_building.direccion_cliente_id << direccion_cliente_id_value
    ...
    show("--------------GS--EDIT-FI-direccion_cliente_id---------.")
