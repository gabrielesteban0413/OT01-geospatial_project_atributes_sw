_block
    ruta_fuente << "C:\\A_GS1_PROYECTOS\\00_MODULOS\\Z_CALIDAD\\Z_AUTOMATIZACION\\CNT_04_pole\\TXT\\E_Status.txt"

    vista << gis_program_manager.cached_dataset(:gis)
    vista.checkpoint("pole_find")  #IMPORT------------------
    sheath_with_locs << vista.collection(:pole)
